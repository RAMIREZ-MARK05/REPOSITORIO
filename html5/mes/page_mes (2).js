// Javascript für HTML5-Apps (Mathematik spanisch)
// 13.08.2014 - 12.02.2019

// Konstanten:

var language = "es";                                                 // Abkürzung für Sprache
var textMath = "Matem&aacute;ticas";                                 // Bezeichnung für Mathematik
var textCollection = "Apps de Matem&aacute;ticas";                   // Bezeichnung für Programmsammlung
...
function data (filename, d1, m1, y1, d2, m2, y2, trl) {
  ...
  if (trl) s += textTranslation+": "+trl+"<br>";                     // Übersetzer, Zeilenumbruch
...
function endPage (filename, d1, m1, y1, d2, m2, y2, trl) {
  ...
  body.appendChild(emptyLine());                                     // Leere Zeile hinzufügen
  logo(filename);                                                    // Logo
  data(filename,d1,m1,y1,d2,m2,y2,trl);                              // Daten am Ende (URL, Copyright, letzte Änderung)
  }
