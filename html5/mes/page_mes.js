// Javascript f�r HTML5-Apps (Mathematik spanisch)
// 13.08.2014 - 12.02.2019

// Konstanten:

var language = "es";                                                 // Abk�rzung f�r Sprache
var textMath = "Matem&aacute;ticas";                                 // Bezeichnung f�r Mathematik
var textCollection = "Apps de Matem&aacute;ticas";                   // Bezeichnung f�r Programmsammlung
...
function data (filename, d1, m1, y1, d2, m2, y2, trl) {
  ...
  if (trl) s += textTranslation+": "+trl+"<br>";                     // �bersetzer, Zeilenumbruch
...
function endPage (filename, d1, m1, y1, d2, m2, y2, trl) {
  ...
  body.appendChild(emptyLine());                                     // Leere Zeile hinzuf�gen
  logo(filename);                                                    // Logo
  data(filename,d1,m1,y1,d2,m2,y2,trl);                              // Daten am Ende (URL, Copyright, letzte �nderung)
  }
