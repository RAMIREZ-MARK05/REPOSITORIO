// Apollonios-Problem CCL (zwei Kreise, eine Gerade)
...
// Sprachabhängige Texte sind einer eigenen Datei (zum Beispiel apolloniosproblemccl_de.js) abgespeichert.
...
function reactionDown (u, v) {
  ...
  var d = distancePoint(u,v,k1.x,k1.y);                    // Abstand vom Mittelpunkt 1
  ...
  d = distancePoint(u,v,k2.x,k2.y);                        // Abstand vom Mittelpunkt 2
...
function reactionMove (u, v) {
  ...
  if (nr == 2) k1.r = distancePoint(u,v,k1.x,k1.y);        // Radius 1 anpassen
  if (nr == 3) {k2.x = u; k2.y = v;}                       // Mittelpunkt 2 anpassen
  if (nr == 4) k2.r = distancePoint(u,v,k2.x,k2.y);        // Radius 2 anpassen
  if (nr == 5) {g.x1 = u; g.y1 = v;}                       // Punkt 1 der Gerade anpassen
  if (nr == 6) {g.x2 = u; g.y2 = v;}                       // Punkt 2 der Gerade anpassen
  paint();                                                 // Neu zeichnen
  }
...
// s1, s2, s3 ... Vorzeichenfaktoren (+1 für einschließende, -1 für ausschließende Berührung)
