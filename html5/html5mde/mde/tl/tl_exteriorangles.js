...
// Sprachabhängige Texte sind einer eigenen Datei (zum Beispiel tl_exteriorangles_de.js) abgespeichert.
...
var T12, T13, T21, T23, T31, T32;                          // Berührpunkte der Ankreise 
...
function update () {
  ...
  T12 = pointBarycentric(-tan1,0,1/tan3);                  // Berührpunkt Ankreis 1 - Verlängerung b (bei C)
  T13 = pointBarycentric(-tan1,1/tan2,0);                  // Berührpunkt Ankreis 1 - Verlängerung c (bei B)
  T21 = pointBarycentric(0,-tan2,1/tan3);                  // Berührpunkt Ankreis 2 - Verlängerung a (bei C)
  T23 = pointBarycentric(1/tan1,-tan2,0);                  // Berührpunkt Ankreis 2 - Verlängerung c (bei A)
  T31 = pointBarycentric(0,1/tan2,-tan3);                  // Berührpunkt Ankreis 3 - Verlängerung a (bei B)
  T32 = pointBarycentric(1/tan1,0,-tan3);                  // Berührpunkt Ankreis 3 - Verlängerung b (bei A)
  }
...
function paint () {
  ...
  if (step == 0 || step == 2 || step >= 6)                 // Gegebenenfalls ... 
    drawAngle(T13,B,C,color4);                             // Außenwinkel beta* für Ankreis 1
  if (step == 0 || step >= 3 && step <= 5)                 // Gegebenenfalls ...
    drawAngle(B,C,T12,color4);                             // Außenwinkel gamma* für Ankreis 1
  if (step == 0 || step == 3 || step >= 6)                 // Gegebenenfalls ...
    drawAngle(T21,C,A,color4);                             // Außenwinkel gamma* für Ankreis 2
  if (step == 0 || step == 1)                              // Gegebenenfalls ...
    drawAngle(C,A,T23,color4);                             // Außenwinkel alpha* für Ankreis 2
  if (step == 0 || step == 1 || step >= 6)                 // Gegebenenfalls ...
    drawAngle(T32,A,B,color4);                             // Außenwinkel alpha* für Ankreis 3
  if (step == 0 || step == 2)                              // Gegebenenfalls ...
    drawAngle(A,B,T31,color4);                             // Außenwinkel beta* für Ankreis 3 
