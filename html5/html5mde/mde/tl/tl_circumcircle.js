// Dreiecks-Labor: Umkreis
// Java-Applet (28.10.2004) umgewandelt
// 12.01.2017 - 25.08.2022
...
function paint () {
  ...
  if (step == 5 || step == 6)                              // Gegebenenfalls ... 
  ...
  if (step >= 1 && step <= 3 || step == 5 || step == 7)    // Gegebenenfalls ... 
    drawDashedLine(U,A,color1);                            // Strecke [UA] gestrichelt
  if (step >= 1 && step <= 4 || step == 7)                 // Gegebenenfalls ...
    drawDashedLine(U,B,color1);                            // Strecke [UB] gestrichelt
  if (step == 1 || step == 4 || step == 5 || step == 7)    // Gegebenenfalls ...
    drawDashedLine(U,C,color1);                            // Strecke [UC] gestrichelt
  if (step == 0 || step == 1 || step >= 7)                 // Gegebenenfalls ...
    drawCircleMP(U,A,color2);                              // Umkreis
  drawVertex(A,vertex1);                                   // Ecke A
  drawVertex(B,vertex2);                                   // Ecke B
  drawVertex(C,vertex3);                                   // Ecke C
  if (step >= 1) drawPoint(U,color2,circumcenter);         // Umkreismittelpunkt U
  }
