...
// Sprachabhängige Texte sind einer eigenen Datei (zum Beispiel tl_start_de.js) abgespeichert.
...
// Seiteneffekt a, b, c, alpha, beta, gamma
...
function reactionNext () {
  ...
  if (step >= 2) bu2.disabled = true;                      // Falls nötig, Schaltknopf "Nächster Schritt" deaktivieren
