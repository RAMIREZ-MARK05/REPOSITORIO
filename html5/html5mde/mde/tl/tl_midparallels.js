// Dreiecks-Labor: Mittelparallelen
// Java-Applet (28.10.2004) umgewandelt
// 09.01.2017 - 22.08.2022
...
// Sprachabhängige Texte sind einer eigenen Datei (zum Beispiel tl_midparallels_de.js) abgespeichert.
...
function paint () {
  ...
  if (step >= 4) drawSegmentPP(M2,M3,color2);              // Mittelparallele zu a
  if (step >= 5) drawSegmentPP(M3,M1,color2);              // Mittelparallele zu b
  if (step >= 6) drawSegmentPP(M1,M2,color2);              // Mittelparallele zu c  
