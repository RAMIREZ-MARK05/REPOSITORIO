// Dreiecks-Labor: Höhen und Höhenschnittpunkt
// Java-Applet (28.10.2004) umgewandelt
// 07.01.2017 - 21.08.2022
...
// Sprachabhängige Texte sind einer eigenen Datei (zum Beispiel tl_orthocenter_de.js) abgespeichert.
...
function paint () {
  ...
  if (step == 0 || step >= 3) drawLinePP(A,F1,color1);     // Höhe h_a (verlängert)
  if (step == 1 || step >= 3) drawLinePP(B,F2,color1);     // Höhe h_b (verlängert)
  ...
  if (step >= 3) drawPoint(H,color2,orthocenter);          // Höhenschnittpunkt H
  }
