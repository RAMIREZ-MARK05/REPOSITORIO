...
function start () {
  ...
  focus(ipM1);                                             // Fokus für das erste Eingabefeld
  ...
  ipM1.onblur = reaction;                                  // Reaktion auf Verlust des Fokus (Masse 1)
  ipV1.onblur = reaction;                                  // Reaktion auf Verlust des Fokus (Geschwindigkeit 1)
  ipM2.onblur = reaction;                                  // Reaktion auf Verlust des Fokus (Masse 2)
  ipV2.onblur = reaction;                                  // Reaktion auf Verlust des Fokus (Geschwindigkeit 2)  
...
function reactionReset () {
  ...
  focus(ipM1);                                             // Fokus für erstes Eingabefeld
  }
...
function input () {
  ...
  if (ae == ipM1) focus(ipV1);                             // Fokus für nächstes Eingabefeld
  if (ae == ipV1) focus(ipM2);                             // Fokus für nächstes Eingabefeld
  if (ae == ipM2) focus(ipV2);                             // Fokus für nächstes Eingabefeld
  if (ae == ipV2) ipV2.blur();                             // Fokus abgegeben
  }
