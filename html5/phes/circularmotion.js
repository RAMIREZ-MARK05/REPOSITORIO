...
function start () {
  ...
  ipR.onblur = reaction;                                   // Reaktion auf Verlust des Fokus (Eingabe Radius)
  ipT.onblur = reaction;                                   // Reaktion auf Verlust des Fokus (Eingabe Umlaufdauer)
...
function input () {
  ...
  if (ae == ipR) focus(ipT);                               // Fokus für nächstes Eingabefeld
  if (ae == ipT) focus(ipM);                               // Fokus für nächstes Eingabefeld
  if (ae == ipM) ipM.blur();                               // Fokus abgegeben
  }
