...
function start () {
  ...
  ip1.onblur = reaction;                                   // Reaktion auf Verlust des Fokus (1. Brechungsindex)
  ip2.onblur = reaction;                                   // Reaktion auf Verlust des Fokus (2. Brechungsindex)
  ip3.onblur = reaction;                                   // Reaktion auf Verlust des Fokus (Einfallswinkel)
  }
