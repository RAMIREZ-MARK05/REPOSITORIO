...
function start () {
  ...
  ip1.onblur = reaction;                                   // Reaktion auf Verlust des Fokus (Eingabe Neigungswinkel)
  ip2.onblur = reaction;                                   // Reaktion auf Verlust des Fokus (Eingabe Gewichtskraft)
  ip3.onblur = reaction;                                   // Reaktion auf Verlust des Fokus (Eingabe Reibungszahl)
...
function reactionEnter (e) {
  ...
  reaction();                                              // Daten übernehmen, rechnen, Ausgabe                         
  paint();                                                 // Neu zeichnen
  }
