...
function start () {
  ...
  ip1.onblur = reaction;                                   // Reaktion auf Verlust des Fokus (Eingabe Grundfläche)
  ip2.onblur = reaction;                                   // Reaktion auf Verlust des Fokus (Eingabe Höhe)
  ip3.onblur = reaction;                                   // Reaktion auf Verlust des Fokus (Eingabe Dichte des Quaders)
  ip4.onblur = reaction;                                   // Reaktion auf Verlust des Fokus (Eingabe Dichte der Flüssigkeit)
