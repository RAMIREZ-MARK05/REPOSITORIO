...
function start () {
  ...
  ip1.onblur = reaction1;                                  // Reaktion auf Verlust des Fokus (1. Brechungsindex)
  ip2.onblur = reaction2;                                  // Reaktion auf Verlust des Fokus (2. Brechungsindex)
  ip3.onblur = reaction3;                                  // Reaktion auf Verlust des Fokus (Einfallswinkel)
...
// Hilfsroutine: Eingabe 1. Brechungsindex

function reaction1 () {
  var n = inputNumber(ip1,numberDigits(nr1),1,5);          // Eingegebener Brechungsindex, eventuell korrigiert
  if (n != n1) {                                           // Falls Änderung ...
    n1 = n;                                                // Brechungsindex übernehmen
...
// Hilfsroutine: Eingabe 2. Brechungsindex

function reaction2 () {
  var n = inputNumber(ip2,numberDigits(nr2),1,5);          // Eingegebener Brechungsindex, eventuell korrigiert
  if (n != n2) {                                           // Falls Änderung ...
    n2 = n;                                                // Brechungsindex übernehmen
    nr2 = ch2.selectedIndex = nMedia-1;                    // Letzter Index der Auswahlliste
    }
  reaction();                                              // Berechnungen, Ausgabe, neu zeichnen
  focus(ip3);                                              // Fokus für nächstes Eingabefeld
  }
  
// Hilfsroutine: Eingabe Einfallswinkel

function reaction3 () {
  eps1 = DEG*inputNumber(ip3,1,0,90);                      // Einfallswinkel (Bogenmaß), eventuell korrigiert
  reaction();                                              // Berechnungen, Ausgabe, neu zeichnen
  ip3.blur();                                              // Fokus abgeben
  }
...
function reactionEnter1 (e) {
  ...
  if (enter) reaction1();                                  // Falls Enter-Taste, Eingabe, Berechnungen, Ausgabe und neu zeichnen
  }
...
function reactionEnter2 (e) {
  var enter = (e.key == "Enter" || e.code == "Enter");     // Flag für Enter-Taste
  if (enter) reaction2();                                  // Falls Enter-Taste, Eingabe, Berechnungen, Ausgabe und neu zeichnen                    
  }
...
function reactionEnter3 (e) {
  var enter = (e.key == "Enter" || e.code == "Enter");     // Flag für Enter-Taste
  if (enter) reaction3();                                  // Falls Enter-Taste, Eingabe, rechnen, Ausgabe und neu zeichnen
  }
