...
function start () {
  ...
  ip1.onblur = reaction;                                   // Reaktion auf Verlust des Fokus (Objektivbrennweite)
  ip2.onblur = reaction;                                   // Reaktion auf Verlust des Fokus (Okularbrennweite)  
