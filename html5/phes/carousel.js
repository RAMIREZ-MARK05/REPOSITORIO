...
function start () {
  ...
  ip1.onblur = reaction;                                   // Reaktion auf Verlust des Fokus (Eingabe Umlaufzeit)
  ip2.onblur = reaction;                                   // Reaktion auf Verlust des Fokus (Eingabe Position Aufhängung)
  ip3.onblur = reaction;                                   // Reaktion auf Verlust des Fokus (Eingabe Fadenlänge)
