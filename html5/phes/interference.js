...
function start () {
  ...
  ipD.onblur = reaction;                                   // Reaktion auf Verlust des Fokus (Eingabefeld Entfernung)
  ipWL.onblur = reaction;                                  // Reaktion auf Verlust des Fokus (Eingabefeld Wellenlänge)
...
function input () {
  ...
  if (ae == ipD) focus(ipWL);                              // Fokus für nächstes Eingabefeld
  if (ae == ipWL) ipWL.blur();                             // Fokus abgeben
  }
