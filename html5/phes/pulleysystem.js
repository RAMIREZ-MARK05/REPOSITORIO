...
function start () {
  ...
  ip1.onblur = reaction;                                   // Reaktion auf Verlust des Fokus (Gewicht der Last)
  ip2.onblur = reaction;                                   // Reaktion auf Verlust des Fokus (Gewicht der losen Flasche)
...
// Reaktion: Eingabe, Rechnung, Ausgabe, neu zeichnen
// Seiteneffekt fG, fGlF, f, xB1, yB1, h, part, xM, yM, Wirkung auf Ausgabefeld und Zeichenfläche
