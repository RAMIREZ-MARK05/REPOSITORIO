...
function start () {
  ...
  focus(ipF);                                              // Fokus für erstes Eingabefeld
  paint();                                                 // Zeichnen
  ...
  ipF.onblur = reaction;                                   // Reaktion auf Verlust des Fokus (Eingabe Kraftbetrag)
  ipA1.onblur = reaction;                                  // Reaktion auf Verlust des Fokus (Eingabe 1. Winkel)
  ipA2.onblur = reaction;                                  // Reaktion auf Verlust des Fokus (Eingabe 2. Winkel)
...
function input () {
  ...
  if (ae == ipF) focus(ipA1);                              // Fokus für nächstes Eingabefeld
  if (ae == ipA1) focus(ipA2);                             // Fokus für nächstes Eingabefeld
  if (ae == ipA2) ipA2.blur();                             // Fokus abgeben
  }
