...
function start () {
  ...
  focus(ipL);                                              // Fokus für erstes Eingabefeld    
  ...
  ipL.onblur = reaction;                                   // Reaktion auf Verlust des Fokus (Eingabe Pendellänge)
...
function input () {
  ...
  if (ae == ipL) focus(ipG);                               // Fokus für nächstes Eingabefeld
  if (ae == ipG) focus(ipM);                               // Fokus für nächstes Eingabefeld
